...
void mDoExt_3DlineMat1_c::draw() {
    ...
    for (s32 i = 0; i < mNumLines; i++) {
        GXSetArray(GX_VA_POS, ((mDoExt_3Dline_c*)((s32)lines + (mIsDrawn << 2)))->field_0x8, sizeof(cXyz));
        GXSetArray(GX_VA_NRM, ((mDoExt_3Dline_c*)((s32)lines + (mIsDrawn << 2)))->field_0x10, sizeof(u8[3]));
        GXSetArray(GX_VA_TEX0, ((mDoExt_3Dline_c*)((s32)lines + (mIsDrawn << 2)))->field_0x18, sizeof(f32[2]));
